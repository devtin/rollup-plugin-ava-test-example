/*!
 * rollup-plugin-ava-test-example v1.0.4
...
function stripJsdocComment (jsDocCommentBlock, replaceValue = '') {
  return trim_1(jsDocCommentBlock.replace(/^ \* ?/mgsi, replaceValue))
}
...
var avaToJson = createCommonjsModule(function (module, exports) {
/*!
 * ava-to-json v1.0.0
 * (c) 2020 Martin Rafael Gonzalez <tin@devtin.io>
 * MIT
...
(function (global, factory) {
	 factory(exports, util, fs, path) ;
}(commonjsGlobal, (function (exports, util, fs, path) {
...
var avaToJson$1 = unwrapExports(avaToJson);
  ...
  return {
    ...
    async transform (code, id) {
      ...
      if (extension && extensions.indexOf(extension) >= 0) {
        ...
        if (await lib.pathExists(unit)) {
          const examples = (await avaToJson$1.parseFile(unit, ava2jsonOptions)).map(avaTestToExample);
...
module.exports = rollupPluginAvaTestExample;
